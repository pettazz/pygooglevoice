...
class Voice(object):
    ...
    def call(self, outgoingNumber, forwardingNumber, subscriberNumber=None):
        ...
        """
        load_and_validate(self.__do_special_page('call', {
    ...
    def cancel(self, outgoingNumber=None, forwardingNumber=None):
        ...
        """
        load_and_validate(self.__do_special_page('cancel', {
    ...
    def send_sms(self, phoneNumber, text):
        ...
        """
        load_and_validate(self.__do_special_page('sms', {
...
class Phone(AttrDict):
    ...
    def __call_forwarding(self, enabled='1'):
        ...
        """
        load_and_validate(self.voice.__do_special_page('forward', {
            'enabled': enabled,
            'phoneId': self.id,
        }))
